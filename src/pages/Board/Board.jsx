...
const Board = () => {
  ...
  const handleClick = (id, player) => {
    ...
    if (selectedFightersQty === 0 && player === "playerOne") {
      setFightersData({
        playerOne: fighters.find((f) => f.id === id),
        playerTwo: {},
      });
    } else if (selectedFightersQty === 1 && player === "playerTwo") {
      setFightersData({
        playerOne: playerOne,
        playerTwo: fighters.find((f) => f.id === id),
      });
    }
  };
